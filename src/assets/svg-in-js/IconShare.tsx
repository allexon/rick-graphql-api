...
const StyledIconShare = styled.svg`
  ...
  &:hover path {
    fill: orange; /* Cor ao passar o mouse */
  }
`;

export const IconShare = ({ width, fill }: Props) => {
  return (
    <StyledIconShare width={width} fill={fill} viewBox='0 0 1024 1024' stroke-width={0} xmlns='http://www.w3.org/2000/svg'>
